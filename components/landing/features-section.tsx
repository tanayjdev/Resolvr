      ...
      <Container className="relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6 lg:gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="relative h-full glass-panel border border-white/10 rounded-3xl p-6 md:p-8 overflow-hidden transition-all duration-500 hover:border-primary/20 hover:bg-white/[0.02] hover:-translate-y-1">
                {/* Hover glow effect */}

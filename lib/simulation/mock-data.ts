...
// Static arrays, seed data, and constants for PathWeaver
// ============================================================
...
import type {
  ...
  export const SEED_TERMINAL_HISTORY: TerminalHistoryLine[] = [
    { text: "operator@pathweaver:~$ kubectl get nodes", variant: "primary" },
    {
    ...
    { text: "operator@pathweaver:~$ ", variant: "primary", isPrompt: true },
  ]

...
export function IncidentPanel() {
  return (
    <div className="glass-panel rounded-xl p-3 sm:p-4 lg:p-5 border border-border">
      <div className="flex items-start gap-2 sm:gap-3">
        <div className="shrink-0 p-1.5 sm:p-2 rounded-lg bg-warning/10 border border-warning/30">
        ...
        <div className="min-w-0">
          ...
          <p className="text-[11px] sm:text-xs lg:text-sm text-muted-foreground leading-relaxed mb-2 sm:mb-3">
            3 nodes in{" "}
            <code className="px-1 py-0.5 rounded bg-secondary text-primary font-mono text-[10px] sm:text-xs">
              us-east-1
            </code>{" "}
          ...
          <div className="flex flex-col gap-1 sm:gap-1.5">
            ...
            <div className="flex items-center gap-2 text-[11px] sm:text-xs text-muted-foreground">
              <Activity className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-warning" />
              <span>
